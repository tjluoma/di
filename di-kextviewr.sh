#!/usr/bin/env zsh -f
# Purpose: Download and install the latest version of KextViewr
#
...
then
	INSTALL_TO='/Volumes/Applications/KextViewr.app'
	TRASH="/Volumes/Applications/.Trashes/$UID"
else
	INSTALL_TO='/Applications/KextViewr.app'
	TRASH="/.Trashes/$UID"
fi
...
DOWNLOAD_PAGE="https://objective-see.com/products/kextviewr.html"

SUMMARY="Modules that are loaded into the kernel are called kernel extension, or 'kexts.' They run at the OS's highest privilege level; ring-0. KextViewr displays all loaded kexts, along with their signing status, full path, VirusTotal detection ratios, and more!"

RELEASE_NOTES_URL='https://objective-see.com/products/changelogs/KextViewr.txt'
