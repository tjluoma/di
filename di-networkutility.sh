#!/usr/bin/env zsh -f
# Purpose:	Download and install the latest version of (Neo) Network Utility
#
...
INSTALL_TO="${INSTALL_DIR_ALTERNATE-/Applications}/Network Utility.app"

XML_FEED='https://api.devontechnologies.com/1/apps/sparkle/sparkle.php?id=900000089'
