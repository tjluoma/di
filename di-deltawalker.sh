...
URL=$(curl -sfLS "https://www.deltawalker.com/assets/js/main.js" | awk -F"'" '/\.dmg/{print $2}')

LATEST_VERSION=$(echo "$URL:t:r" | tr -dc '[0-9]\.')

# No release notes - https://www.deltawalker.com/new-and-noteworthy comes close but isn't up-to-date
