#!/bin/zsh -f
# Purpose: Download and install/update the latest version of "Ostiarius"
#
...
DOWNLOAD_PAGE="https://objective-see.com/products/ostiarius.html"

RELEASE_NOTES_URL='https://objective-see.com/products/changelogs/Ostiarius.txt'
