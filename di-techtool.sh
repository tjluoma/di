...
FILENAME="$HOME/Downloads/TechToolPro-${${LATEST_VERSION}// /}_${${LATEST_BUILD}// /}.zip"
...
then
	...
	then
		...
		RELEASE_NOTES=$(lynx -assume_charset=UTF-8 -pseudo_inlines -nolist -dump -nomargins -width=10000 "$RELEASE_NOTES_URL")
