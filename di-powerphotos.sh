#!/usr/bin/env zsh -f
# Purpose:	Download and install PowerPhotos from https://www.fatcatsoftware.com/powerphotos/
#
...
INSTALL_TO="/Applications/PowerPhotos.app"

XML_FEED='https://www.fatcatsoftware.com/powerphotos/downloads/appcast.xml'

# Don't indent the 'sed' line
