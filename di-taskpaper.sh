...
then
	...
	then
		...
		echo "	See <https://itunes.apple.com/us/app/taskpaper-plain-text-to-dos/id1090940630?mt=12> or"
		echo "	<macappstore://itunes.apple.com/us/app/taskpaper-plain-text-to-dos/id1090940630>"
