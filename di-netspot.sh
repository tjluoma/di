...
then
	...
	then
		...
		echo "	See <https://itunes.apple.com/us/app/netspot-wifi-survey-wireless-scanner/id514951692?mt=12> or"
		echo "	<macappstore://itunes.apple.com/us/app/netspot-wifi-survey-wireless-scanner/id514951692>"
