...
then
	INSTALL_TO='/Volumes/Applications/Textual.app'
else
...
then
	...
	then
		...
		echo "	See <https://apps.apple.com/us/app/textual-7/id1262957439?mt=12> or"
		echo "	<macappstore://apps.apple.com/us/app/textual-7/id1262957439>"
