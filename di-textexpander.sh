#!/usr/bin/env zsh -f
# Purpose: 	Download and install the latest version of TextExpander.app
#
...
INSTALL_TO="${INSTALL_DIR_ALTERNATE-/Applications}/TextExpander.app"

	# XML_FEED officially is "https://cgi.textexpander.com/appcast/textexpander.cgi"
	# but it refers to itself for Mac as
XML_FEED='https://cgi.textexpander.com/appcast/TextExpander-macOS.xml'
...
RELEASE_NOTES_HTML=$(echo "$INFO" | sed -e 's#.*<!\[CDATA\[##g' -e 's#\]\]></description>.*##g')
