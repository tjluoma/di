#!/usr/bin/env zsh -f
# Purpose:	Download and install the latest version of Screenflow
#
...
INSTALL_TO='/Applications/ScreenFlow.app'

XML_FEED='https://www.telestream.net/updater/screenflow/appcast.xml'
