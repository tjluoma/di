...
then
	...
	then
		...
		echo "	See <https://itunes.apple.com/us/app/revisions-for-dropbox/id819348619?mt=12> or"
		echo "	<macappstore://itunes.apple.com/us/app/revisions-for-dropbox/id819348619>"
