...
then
	INSTALL_TO='/Volumes/Applications/CardHop.app'
else
...
then
	...
	then
		...
		echo "	See <https://apps.apple.com/us/app/cardhop/id1290358394?mt=12> or"
		echo "	<macappstore://apps.apple.com/us/app/cardhop/id1290358394>"
