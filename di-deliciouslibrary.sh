#!/usr/bin/env zsh -f
# Purpose: from https://www.delicious-monster.com
#
...
then
	INSTALL_TO='/Volumes/Applications/Delicious Library 3.app'
	...
	then
		...
		echo "	See <https://apps.apple.com/us/app/delicious-library-3/id635124250?mt=12> or"
		echo "	<macappstore://apps.apple.com/us/app/delicious-library-3/id635124250>"
...
URL="$INFO[2]"
	...
	# LATEST_VERSION might have a 'v' in it. So be safe, let's get rid of everything that's not a digit or a "."
LATEST_VERSION=$(echo "$LATEST_VERSION" | tr -dc '[0-9]\.')
