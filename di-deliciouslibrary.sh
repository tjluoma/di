...
then
	...
	then
		...
		echo "	See <https://itunes.apple.com/us/app/delicious-library-3/id635124250?mt=12> or"
		echo "	<macappstore://itunes.apple.com/us/app/delicious-library-3/id635124250>"
