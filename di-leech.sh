...
then
	INSTALL_TO='/Volumes/Applications/Leech.app'
else
...
then
	...
	then
		...
		echo "	See <https://apps.apple.com/us/app/leech/id1101735327?mt=12> or"
		echo "	<macappstore://apps.apple.com/us/app/leech/id1101735327>"
