#!/bin/zsh -f
# Purpose: Download and install (or update) the latest version of Logos.com for Mac (note: this is for version 6. Version 7 is also available)
#
...
INSTALL_TO='/Applications/Logos 6.app'
