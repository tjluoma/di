#!/usr/bin/env zsh -f
# Purpose:	Download and install the latest version of Spotdox
#
...
RELEASE_NOTES_URL='https://spotdox.herokuapp.com/version_history'
...
then
	...
	echo "$NAME: Release notes can be found at <${RELEASE_NOTES_URL}>"
